...
plot(x=c(1,100),y=c(0,0.3),type="n",xlab="Generations",ylab="Frequency",cex.axis=1.2,cex.lab=1.4)
...
#dev.copy2pdf(file="~/Dropbox/Courses/Popgen_teaching_Notes/figures/Haploid_geom_traj.pdf")
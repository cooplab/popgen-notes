...
\begin{question}
{\bf A)} Explain why a one-locus model cannot explain the evolution of intrinsic postzygotic sterility. \\
{\bf B)} Briefly outline the Dobzhansky-Muller incompatibility (DMI) model for the evolution of intrinsic postzygotic sterility.  
\end{question}


\begin{question}
Explain why the number of DMIs is expected to snowball with divergence time.
\end{question}

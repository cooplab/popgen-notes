...
\begin{question}
Analyzing polymorphism and divergence data for a gene you calculate the  following McDonald‐Kreitman table.
\begin{center}
\begin{tabular}{ccc}
...
polymorphisms, given the 80 synonymous substitutions how many

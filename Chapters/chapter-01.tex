...
rules of Mendelian transmision. Consider the probability $\P(\text{I\&J IBD} |~ \text{i\&j  1 IBD})$, i.e. that our
...
\begin{marginfigure}
\begin{center}
\includegraphics[width= \textwidth]{figures/Child_first_cousins_Homozy_BD_new}
\end{center}
...
pink  allele IBD. The offspring of first cousins is homozygous by
  descent at this locus for the pink allele. You can simulate more
  examples for yourself \href{https://cooplab.shinyapps.io/Shiny_pedigree_sims/}{here}.} \label{fig:IBD_cousins_cartoon}
\end{marginfigure}

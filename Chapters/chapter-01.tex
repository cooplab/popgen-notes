...
\begin{marginfigure}
\begin{center}
  \includegraphics  [width= \marginwidth]{illustration_images/alleles_genotypes/grey_wolf/5988399184_0c36a8e51c_z.jpg}
\end{center}
...
\begin{marginfigure}
\begin{center}
\includegraphics[width= \marginwidth]{figures/Pop_struct/FST_hierarchy.pdf}  %
\end{center}
...
\erin{should there be a bar (avg) over Var(pi)?}
...
pioneered by Cavalli-Sforza and colleagues and \erin{fragmented sentence. also overlapping text in margin can't be read} With large genotyping datasets PCA has made come back. \cite{menozzi:78,patterson:06}
% TODO: citations.
...
alleles are sampled binomially from the mean frequency ($\sqrt{p_{\ell}
  ...
  sample. \erin{figure missing!} Figure \ref{fig:chimp_PCA} shows a PCA from Becquet \emph{et al.}

...
\gc{Up to this point we have assumed that there is at most one
  ...
  descent thanks to receiving IBD alleles via different these
...
are $n_{i,~B}$ and $n_{i,~C}$ respectively, for a total of $n_i$ meioses linking
B and C via $A_i$. Then the kinship coefficient of the parents,
i.e. the inbreeding coefficient of the child is
\begin{equation}
 F = \sum_i \frac{1}{2^{n_i}} \big( 1+ f_{A_i} \big)
\end{equation}
...
and indeed he was a very sickly man who left no descendants thanks to his
infertility. \sidenote{Pedro Gargantilla who performed his autopsy stated
  ...
  head was full of water." Although, while some of this description

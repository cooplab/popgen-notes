...
H_T$, \sidenote[][-4cm]{This observation that the average
  heterozygosity of the sub-populations must be less than of equal to
  that of the total
  population is called the Wahlund effect.} and so $\fst \geq 0$ and $\fis \leq \fit$. Furthermore, if we have multiple sites, we can replace $H_I$, $H_S$, and

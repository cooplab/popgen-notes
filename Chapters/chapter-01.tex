...
($2p_{\ell}$) and divide through by the square root of the expected variance \erin{I think the denominator in 2.24 and 2.25 is maybe missing a factor of 2 because it's diploid...b/c variance for a binomial sample size n is npq so wouldn't diploid be n=2 .. or maybe I'm missing something?} assuming that
...
the $[i,~j]$ given by \erin{why are we summing instead of averaging over loci? isn't this missing a 1/(S-1) term?}
\begin{equation}

...
(a-l) are from {\it D. melanogaster};
 ...
 set of cloumns (a-l ) from {\it D. yakuba}. The last column shows
...
$\pi$. 
For our example, for our ADH locus, Table \ref{Table:ADH}, we have
6 sequences in {\it D. simulans}  (a-f), there's a total of 15 ways of pairing
the sequences, and 
\begin{equation}
...
\begin{marginfigure}
\begin{center}
\includegraphics[width= \textwidth]{illustration_images/alleles_genotypes/Kermode_bear/Kermode_bear.jp2}
\end{center}

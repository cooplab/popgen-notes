...
\includegraphics[width= \textwidth]{illustration_images/alleles_genotypes/greenish_warbler/10036311396_14915d1715_z.jpg}
  \caption{Greenish warbler, subspp. viridanus ({\it Phylloscopus
    ...
    British Islands. 1885. Lilford T. L. P.}\label{fig:greenish_warbler}
\end{marginfigure}
...
the $[i,~j]$ given by
\begin{equation}
\frac{1}{S} \sum_{\ell=1}^S \frac{(g_{i,\ell} - 2p_{\ell})(g_{j,\ell} - 2p_{\ell})}{p_{\ell}(1-p_{\ell})} \label{eqn:kinship_mat}
\end{equation}
...
\end{figure}
\erin{figures need captions, clearly you're still working on it}

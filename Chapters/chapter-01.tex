...
red region.
  \begin{figure}
  \begin{center}
    \includegraphics[width= 0.5 \textwidth]{figures/sharing_relatives/first_cousin_offspring.pdf}
\end{center}
...
ranging from 500kb up to many megabases. Figure
...
homozygosity, however, much of this is due to many short runs of homozygosity. \erin{It's hard for me to read these figures because they are very small. But, it looks like Dobermans have a large portion of long blocks to me (aren't they the top line in orange?), so maybe a better example would be French bulldogs for older inbreeding (and less inbreeding) compared to the English bulldog.} This indicates that the inbreeding in Doberman Pinschers
is many generations back. In contrast, English bulldogs have lower levels of inbreeding, however, this is contained in long blocks of homozygosity. This suggests that English bulldogs have had high levels of inbreeding in
the recent past. 
...
$H_T$ with their averages across loci (as above). \sidenote{Averaging heterozygosity across loci first, then calculating $\fst$, rather than calculating $\fst$ for each locus individually and then taking the average, has better statistical properties as statistical noise in the denominator is averaged out.}

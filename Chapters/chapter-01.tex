...
of two, and so our eqn is a covariance divided by a variance and so
...
\frac{1}{K} \sum_{i=1}^K q_i^2 \right) -  \bar{p}^2-\bar{q}^2 }{2
       \bar{p}\bar{q}}  \label{eqn:fst_var_middle}\\
...
subpopulation labels. \sidenote[][]{This follows because the
  numerator, in step eqn \eqref{eqn:fst_var_middle}, 
...
\end{equation}
Note that this is the sample covariance, and is very similar to those we

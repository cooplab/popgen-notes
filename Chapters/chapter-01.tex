...
\end{center}
\caption{\gc{The decay of LD from an initial value of $D_0=0.25$ over time due for a pair of loci $r$ apart.} \label{fig:LD_time}
\end{marginfigure} 
\begin{marginfigure}
\begin{center}
\includegraphics[width=\textwidth]{figures/LD_decay/LD_decay_recom.pdf}
\end{center}
\caption{\gc{The decay of LD from an initial value of $D_0=0.25$ over time due for a pair of loci $r$ apart.} \label{fig:LD_recom}
\end{marginfigure} 

...
\begin{figure*}[!h]
\begin{center}
\includegraphics[width= 0.75 \textwidth]{figures/CEU_YRI_separately_HWE.png}
\end{center}
...
\end{tabular}
\end{center}
\caption{Probability that two individuals ($i$ and $j$) of a given relationship share 0, 1, or 2 alleles
...
\item The relationship between allele frequencies and genotype frequencies.
 \item how under random mating we can derive expectations of the genotype frequencies (Hardy Weinberg), and deviations away from these expectations.
\item The sharing of alleles and genomic segments among relatives.
\item How the inbred offspring of closely related individuals have increased homozygosity and genomic runs of homozygosity. 
\item How inbreeding coefficients can be calculated from genetic data.
\end{ChapterSummary}
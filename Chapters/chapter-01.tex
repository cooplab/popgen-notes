...
\end{center}
\caption{Eurasian Lynx ({\it Lynx lynx}). \BHLNKC{An introduction to the study
...
\end{center}
\caption{Charles the second of Spain (by Juan Carre\~{n}o de Miranda,
...
\includegraphics[width=
  ...
  \caption{ Principal Component Analysis by  \citet{becquet:07} using the same chimpanzee data as in Figure
    ...
    the right panel (\PLOSccBY). PCA, The individuals

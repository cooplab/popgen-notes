...
($2\p_{\ell}$) and divide through by the expected variance assuming that
...
ring, and the sampling locations are shown in figure \ref{fig:Gwarbler_geo}. It is
thought that the spread from the soutj, northward in two different directions around the inhospitable Himalayan
...
\begin{figure}
\includegraphics[width= 0.5 \textwidth]{figures/warbler_PCA_figs/warbler_geo_map.pdf}
    \caption{}
\label{fig:Gwarbler_geo} 
\end{figure}

\citet{alcaide:14}  sequenced their samples at 2,334 snps. In figure

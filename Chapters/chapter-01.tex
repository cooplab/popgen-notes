...
\begin{figure}
\begin{center}
\includegraphics[width= 0.75 \textwidth]{figures/sharing_relatives/First_cousin_overlap.pdf}
\end{center}
...
coloured red, those that your cousins inherited are coloured blue. In the third panel we show the overlapping genomic regions in purple, these regions will be IBD in you and your cousin. Details about how we made these simulations here.
} \label{fig:first_cousin_IBD}  
\end{figure}


You and your first cousin by share will share at least one allele of your genotypes in these purple regions. There's a range of methods to detect such sharing. One way is to look for unusually long stretches of the genome where two individuals are never homozygous opposite alleles. By identifying pairs of individuals who share an unusually large number of such putative IBD blocks were can hope to  

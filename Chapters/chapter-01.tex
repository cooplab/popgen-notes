...
/iploid individuals in the population. We can then define the relative
...
and increased hybridization with the blue-winged  warbler, which is moving north into its range, also poses a
significant issue. \citet{Toews:16} investigated the population
...
%JRI: sure, but a few lines above you define LD as a correlation so why are you showing us a covariance?
\begin{equation}
D_{AB} = p_{AB} - p_Ap_B
\end{equation}

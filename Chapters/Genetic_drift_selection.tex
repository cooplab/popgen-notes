...
\caption{The probability of the fixation of a new mutation with
  ...
  neutral expectation as $N_es$ moves passed $1$. \gitcode{https://github.com/cooplab/popgen-notes/blob/master/Rcode/prob_fix_diffusion.R}} \label{fig:prob_fix_diffusion}
\end{figure}
...
\caption{Coquerel's Sifaka ({\it Propithecus coquereli}). \BHLCC{A
    hand-book to the primates (1894). Forbes, H. O.}{https://www.flickr.com/photos/biodivlibrary/6029124104}{Smithsonian Libraries}{2.0} } \label{Cuttlefish}
\end{marginfigure}

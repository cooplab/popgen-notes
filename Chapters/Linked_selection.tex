...
Genetic drift is not the only source of randomness in the dynamics of
alleles. An allele is present on a set of random genetic backgrounds. For example, when a beneficial allele arises via a single mutation, it arises on
...
\subsection{The genome-wide effects of linked selection.}

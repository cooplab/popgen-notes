...
with the alleles present shown as coloured blocks.Figure from \hyper{https://github.com/PenningsLab/ClonalInterferenceHIV}{Pleuni Pennings}} \label{fig:HIV_sweep}
\end{figure}

...
soften the impact \ec{of selection on genomic diversity}, and so are called 'soft sweeps'.
...
diversity linked to selected sites. This is because \ec{the diversity-reducing effects of high variance in reproductive success are compounded over the generations when there is heritable variance in fitness} 
\citep{Robertson:61,Santiago:95,Santiago:98,Barton:00,Neher:13,Good:14}. \erin{last two citations are appearing as ?'s} Many

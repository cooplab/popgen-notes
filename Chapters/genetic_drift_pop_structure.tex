...
can start to genetically diverge from each other To answer these
...
coalesce with each other. However, when there is population structure this assumption is violated. \\

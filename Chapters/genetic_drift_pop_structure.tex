...
\begin{question} 
The African and European populations split $\sim$100 thousand years
...
chimps split 6.5 Million years ago ($t_C$). A population tree diagram, not to scale, is shown above. Assume a generation time of 30 years, and an
effective population size of 10,000 in all populations. Assume, for the sake of the question, that there is no gene flow
between populations after they split. Further, assume that lineages
sampled from the
...
{\bf A)} On the population tree (above) the dashed lines show an

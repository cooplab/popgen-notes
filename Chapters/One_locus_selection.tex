...
\end{tabular}
\end{center}
\erin{I think the fitness calculated above in the 3rd row should be Adult/Juv. not Juv./Adult} The heterozygotes have increased in frequency dramatically in the
...
\end{center}
\caption{ } \label{fig: het_advant_traj}
\end{marginfigure}


In this case, when allele $A_1$ is rare, it is often found in a
heterozygous state, while the $A_2$ allele is usually in the
homozygote state and so it increases in frequency. However, when
allele $A_1$ is common, it is often found in a less fit homozygous state, while
allele $A_2$ is often found in a heterozygous state; thus it is
...
%=======
%found in Soay sheep, a population of feral sheep on the island of Soay
%(about 40 miles off the coast of Scotland).  A large-effect locus
%controlling horn size is polymorphic in this population, with two
%alleles Hop and Ho+ segregating. The Ho+ allele is associated with
%growing larger horns, while the Hop allele is associated with smaller
%horns, with a reasonable proportion of Hop homozygotes developing no
%horns at all. \ec{While the largest horned males have the highest fecundity, they are least likely to survive the winter, having expended a great deal of energy and time fighting other males over potential mates, while their lesser-horned peers fattened up for winter. Due to this trade-off between survival and fecundity, the heterozygotes with moderate sized horns have the highest fitness, and the Hop allele is maintained as a balanced polymorphism.} \erin{this paragraph was missing the end of the Soay sheep story so I've attempted to fill in..}
%>>>>>>> a939a6300e85a26497ba60f58a276c880b4d0e99
...
\caption{In {\it Pseudacraea eurytus} there are two homozygotes morphs that mimic
 a different blue and orange butterfly; the heterozgote fails to mimic

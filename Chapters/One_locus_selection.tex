...
equilibrium is unstable. If $p<p_U$, then $\Delta p_t $ is negative %emjo: should it be p_e instead of p_u?
...
\end{figure}
The genetic variation for these three morphs is potentially maintained by

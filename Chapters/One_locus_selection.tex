...
selection is not guaranteed to increase mean fitness. One place where
...
This section will be somewhat of a rogues gallery tour of some of the various
genetic conflicts that occur and selfish genetic elements that can
arise.  
...
reproductive value of daughters is $1$. Given this the reproductive

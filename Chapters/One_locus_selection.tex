...
\gc{A classic example of bet hedging is in delayed seed germination \citep{cohen1966optimizing}.}
...
Bet hedging has been hypothesized in a range of organisms, with strong
recent interest in micro-organisms. One potential example of
bet-hedging occurs is the long latent phase of the Chicken Pox virus, varicella zoster
virus. After it causes chicken pox it enters a latent phase, resides inactive in neurons in
...
\begin{marginfigure}
\begin{center}
\includegraphics[width= \textwidth]{Journal_figs/single_locus_selection/Sex_ratio_basolo/Sex_ratio_basolo.pdf}
\end{center}
...
Now from the perspective of the autosomes a 50/50 sex ratio represents
...
as it is over transmitted through males, even if it somewhat reduced
the fertility of the males. The spread of this allele would strongly
...
of a hairpin small interfering RNA. Figure from \citet{ferree2007distorted}, \PLOSccBY} \label{fig:dox_cartoon}
\end{figure}
...
dramatic case, a
male-killing {\it Wolbachia} strain forced a sex ratio of 100 females
...
autosomal supressing allele. The autosomal supressor allele likely
spread very rapidly

...
\end{equation}
Thus the cline will be wider if individuals dispersal further, higher
$\sigma$, and selection is weaker, smaller $s$. The appendix below talks through the math underlying these
ideas in more detail.


\citet{lenormand1999tracking} collected mosquito {\it Culex pipiens}
in a north–south transect moving away from the Southern French
coast. Near the coast pesticides are used, but areas just a few tens
of km from the coast were untreated. 
explored allele frequencies in 

\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{Journal_figs/single_locus_selection/Culex_resistance/culex_resistance.pdf}
\end{center}
\caption{Allele frequency clines of two pesticide resistance alleles, at the Ace 1 and Ester genes, in the
 ...
 areas as we move away from the French coast. The dots show observed allele frequencies, the solid lines clines fit under a migration-selection
  balance model of a cline. } \label{fig:cline_culex}
\end{figure}

...
dark than the surrounding desert. \begin{figure}
\begin{center}
  \includegraphics[width = 0.8 \textwidth]{illustration_images/single_locus_selection/chaetodipus_pocket_mice/chaetodipus.png}
\end{center}
\caption{} \label{fig:} 
\end{figure}  Many populations of small animals

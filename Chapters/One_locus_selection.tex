...
\caption{Frequency of the Lactase persistence allele in ancient and
  ...
  Marciniak for sharing these data. \gitcode{https://github.com/cooplab/popgen-notes/blob/master/Rcode/Lactase_example/Lactase_plots.R}} \label{fig:haploid_geo}
\end{figure}
...
plants don't put all of their energy into seeds for next year. It can
even make sense to spread your bets even if that comes at am average cost.
...
high a variance across generations. 


\graham{Add arg. about bet hedging? } %https://twitter.com/rlmcelreath/status/1129013411344453632

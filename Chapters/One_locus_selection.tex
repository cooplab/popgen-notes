...
other rarer allele. In our case of heterozygote advantage the
relative fitnesses of our three genotypes were not a function of the
...
are called frequency-dependent selection. Negative frequency-dependent selection, where the fitness of an allele
(or phenotype) decreases as it becomes more common in the population,
may act to maintain genetic and phenotypic diversity within
populations. While cases of long-term heterozygote advantage may be somewhat rare in nature,
...
species. For example, in negative frequency-dependent dynamics can
arise in predator-prey or pathogen-host dynamics, where
alleles conferring common phenotypes are at a disadvantage because 
predators or pathogens evolve or learn to counter the phenotypic effects of
common alleles.
...
deceptive Elderflower orchid ({\it Dactylorhiza
  sambucina}). There are populations of these orchid polymorphic for 
yellow- and purple-flowered individuals throughout Europe, with the
...
pollinators. These plants are typically pollinated by newly emerged
...
could result in negative frequency dependent selection, by setting up
experimental plots of the plants out in the field where their varied
the frequency of the two morphs. Their measurements of the relative
male and female reproductive success of the yellow morph
are shown in Figure \ref{fig:Elderflower_orchids_fitness}. When the yellow morph is rare it has
...
maintained in this population, and presumably Europe-wide, due to this negative freqeuncy-dependent
selection. The yellow morph is found at $\sim 69\%$ in the region of
France where this experiment was conducted, consistent with the frequency where the two
...
\end{center}
\caption{Measures relative male- and female- reproductive success of the yellow Elderflower orchid morph
  as a function of the yellow morph in experimental plots. Male
  reproductive success is measured in terms of the \% of pollinia
  removed front a plant, female reproductive success is measured in terms of the
  \% of stigmas receiving pollinia on a plant. These measures are made
relative by divide the reproductive success of the yellow morph by the
mean of the yellow and purple morph. Pollinia are the pollen masses of
orchids, and other plants, where individual pollinium are transferred as a single unit by pollinators.} \label{fig:Elderflower_orchids_fitness}  
\end{figure}
...
lek, with the males gathering on open ground to display. There are
three different male morphs differing in breeding
strategy. The large majority of males are `Independent', with black or
chestnut ruff plumage, who try to defend and display on small territories. `Satellite' males, with white ruff plumage, make
...
in 2006. These Faeder males make up less than 1\% of males and are female mimics who's plumage closely resembles
that of females. Faeder males are `sneaker' males who hang
around the terrtories of Independents and try to make with females,
despite their smaller size they have larger testicles presumably to
...
are controled by three alleles at a single autosomal locus. With the
...
(?).} \label{fig:Ruff}  
\end{figure}
This genetic variation for these three morphs is potential maintained by
...
life-time reproductive success. However, Satellite and Faeder males
are totally reliant on the lekking Independent males, and so both of
these alternative strategies cannot become ovely common in the
population. The locus controlling these differences has been mapped,
and the alleles have persisted for roughly four million years
\citep{kupper2016supergene,lamichhaney2016structural}. While this mating system is
bizarre, the frequency dependent dynamics means that it has been round
longer than we've been using stone tools. \\ 

While these examples seems little involved, they must be simple
compared to the complex dynamics that maintain the hundreds of alleles
present at the genes in the Major histocompatibility complex (MHC) complex. These
...
alleles to be favoured. Balancing selection at the MHC has maintained
some polymorphisms for tens of millions of years, such that some of
your MHC alleles may be closer to other primates than they are to your
close human friends. 
...
Theodor Seuss Geisel}. If you've read this send Prof Coop a picture of
the East and West Beast. We'll think of a bi-allelic model where

...
alleles. \citet{dobzhansky1943,wright:46}
...
\caption{{\bf Left)} Seasonal variation in the frequency of the `Standard' inversion allele in
  ...
  over four years. Data from \ref{wright:46}. {\bf Right)} The
...
deviation of this distribution). We'll think of a balletic model where
our allele 1 has an selective advantage $s$ over allele $2$ to the east of our transition, and
this flios to allele $2$ having this advantage west of the
transition. 

To model our abrupt environmental
transition we'll assume that

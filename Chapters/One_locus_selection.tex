...
\ec{In the models and examples above, heterozygote advantage maintains multiple alleles in the population} because the common allele has a disadvantage compared to the
...
\ec{can} act to maintain genetic and phenotypic diversity within
...
pollinators. \ec{Thus these} plants are typically pollinated by newly emerged
...
could result in negative frequency-dependent selection; \ec{out in the filed, the researchers set up
...
male and female reproductive success of the yellow morph \ec{across these experimental plots}. When the yellow morph is rare, it has
...
lek, with the males gathering on open ground to display \ec{and attract females}. There are
three different male morphs differing in their breeding
...
in 2006 \citep{jukema2006permanent} and makes up less than 1\% of males. \ec{These Faeder males are female mimics who hang
...
While these examples \ec{may seem somewhat} involved, they must be simple
...
your MHC alleles may be \ec{genetically more closely related} to {MCH alleles in} other primates than they are to \ec{alleles in} your
close human friends. 

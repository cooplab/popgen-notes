...
\gc{Our two alleles were maintained in the population by heterozygote
...
\end{marginfigure}
\gc{As one example of negative frequency-dependent selection consider the two flower colour morphs in the
...
in 2006. These Faeder make up less than 1\% of males and are female mimics who's plumage closely resembles
that of females. These Faeder males are `sneaker' males who hang
around the territories of Independents and try to make with females,

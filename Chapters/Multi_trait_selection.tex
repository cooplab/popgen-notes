...
\subsection{Hamiliton's Rule and the evolution of altruistic and
  selfish behaviours}
\begin{quotation}
``~`the only reason for making is a buzzing-noise that I know of is
...
--Winnie-the-Pooh in \citet{milne}
\end{quotation}

One of the seismic shifts caused Darwinian thought is the realisation that organisms don't exist for the benefit of species. 
Bees didnt evolve to pollinate flowers, any more than they 
evolved to make honey so that we can eat it. If we can say that there is a `reason' why organisms exist it is only to leave offspring to the next generation. 
However, there's a wrinkle to this view. Worker bees don't make honey
...
%% reciprocal altuisim Quller https://www.pnas.org/content/pnas/108/Supplement_2/10792.full.pdf

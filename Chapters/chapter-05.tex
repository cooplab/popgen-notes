...
\sidenote{The actual dynamics observed by \citeauthor{Barrett:08} as
  in the very young selection reverses direction}
...
heterozygote. This calculation does not rely on the genotype
frequencie being at their HWE in the juveniles.
...
\end{center}
\caption{Data from \citeauthor{elton:42}, redrawn from \citeauthor{Allendorf:09}.} \label{fig:Fox_morph_freqs}
\end{marginfigure}
...
alleles with recessive deleterious effects. One example of inbreeding

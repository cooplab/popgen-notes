...
Individuals are temporary, their phenotypes are temporary, and their genotypes are temporary. Sustained phenotypic evolutionary change due to natural selection occurs because of changes in the genetic composition of the population. To understand these changes, we need to understand how the frequency of alleles (genes) changes over time due to natural selection.  
...
\end{figure}
The rapid spread of this drug-resistant allele through the population is driven by the much greater relative fitness of the drug-resistant allele over the original strain \ec{in the presence of the anti-retroviral drug}. 
...
\end{equation}
dropping the \ec{subscript $t$ for the} dependence of the mean fitness on time in our notation, but remembering it.
...
Moreover, eqn.\ \eqref{eq:estTau} for the \ec{number of generations} $\tau$ it takes for a certain change in frequency to occur becomes
\begin{equation}
	\label{eq:estTauExpl}
...
With the advent of techniques to sequence ancient human DNA, researchers can now potentially track the frequency of selected mutations over thousands of years. The frequency of a Lactase persistence allele in \ec{ancient} Central European populations is shown in Figure \ref{fig:LCT_freqs}. The allele is absent more than 5,000 years ago, but now found at frequency of upward of $70\%$ in many European populations. 
...
increases from birth to adulthood in proportion to $nicefrac{W_{11}}{\Wbar}$. In
...
\end{equation}
where, for notational simplicity, we have omitted \ec{subscript t for} the dependence of mean and marginal fitnesses on time.\\
...
generally we can use this correspondence of the trajectory additive
diploid model to the haploid model to understand how quickly allele
frequencies should change between arbitrary frequencies, given a selection coefficient.\\

\begin{marginfigure}
\begin{center}
  \includegraphics[width = \textwidth]{illustration_images/single_locus_selection/killifish/20974603315_1f9775189e_z.jpg}
\end{center}
\caption{} \label{fig:killifish}
\end{marginfigure}
...
\end{question}
 ...
 \erin{Q not done at the time I read through. Done editing up to here.}

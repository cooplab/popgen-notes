...
Individuals are temporary, their phenotypes are temporary, their genotypes are temporary. Sustained phenotypic evolutionary change to natural selection occur because of changes in the genetic composition of the population. To understand these changes we need to understand how the frequency of alleles  (genes) changes over time due natural selection.  
...
As an example a rapid response to selection on an allele in a haploid population we can consider some data on the evolution of drug resistant viruses. \citet{feder2017} studied viral dynamics in a  macaques infected with a strain of simian immunodeficiency virus that carry the HIV-1 reverse transcriptase coding region. Twelve weeks after infection the macaques were treated with an anti-retroviral drug that targeted the the virus' reverse transcriptase protein. The viral load of the macaque's blood plasma is shown as a black line in Figure \ref{fig:HIV_viral_freqs}. Note how the viral load starts to drop once the drug is administered. 

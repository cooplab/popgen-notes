...
\end{center}
\caption{Australian Honey-pot Ant ({\it Camponotus inflatus}). From Ants,
  bees, and wasps; a record of observations on the habits of the
  social Hymenoptera (1897) Lubbock, J. Honey ants are gorged with
  honeydew collected by their nest mates, and used as a food storage
...
\marginnote{In the usual formulation of Hamilton's Rule our
  $2F$ is replaced by the `Coefficient of relationship', which is the
...
phenotypes. \marginnote{ Here we'll follow a simplified version of
  \citet{queller1992quantitative}'s treatment, to re-derive Hamilton's
  rule in a quantitative genetics framework (Hamilton's original papers did this in a population genetics framework).}
...
\begin{marginfigure}
\begin{center}
\includegraphics[width= \textwidth]{illustration_images/Quant_gen/Argus_pheasant/Argus_pheasant.png}
\end{center}

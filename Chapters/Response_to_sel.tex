...
guppies, females show a preference for males with more orange colouration.

colouration. \begin{marginfigure}
\begin{center}
\includegraphics[width=\textwidth]{illustration_images/Quant_gen/Guppies/1439_fish_40.png}
\end{center} \label{fig:assort_mating_guppies}
\caption{Poecilia reticulata. }
\end{marginfigure} 
c \citeauthor{houde:94} established four replicate

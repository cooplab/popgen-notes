...
\caption{Bars show the totall number of births with different birth
  ...
  Table 2 i \& ii, collapsing male and female births, \gitcode{https://github.com/cooplab/popgen-notes/blob/master/Journal_figs/Quant_gen/birth_weight/birth_weight_selection.R} } \label{fig:Birth_weight}  
\end{marginfigure}

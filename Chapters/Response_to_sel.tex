...
in size and form, can the selection we see every day possibly explain
these changes?


To study this we need some measure of the rate of phenotypic
...
proportional fold chan, which makes sense as a
...
change \citeauthor{haldane1949suggestions} proposed that we call the
units of this measure `the Darwin', with a one Darwin change
corresponding to a $e\approx 2.71$
fold change in a Million years, a two change corresponding to a
...
considerably expanded by \citet{uyeda2011million}.

\begin{figure}
  \begin{center}
    \includegraphics[width= \textwidth]{Journal_figs/Quant_gen/Uyeda_evol_rates/Uyeda_evol_rates.pdf}
\end{center}
\caption{\gc{Caption needed}} \label{fig:uyeda_gingerich}  
\end{figure}
Over short timescales we see incredibly rapid evolution, note the high
rates on the left of Figure \ref{fig:uyeda_gingerich}.
Following the invasion the green crab ({\it Carcinus maenas})
drove the evolution of more robust shells in populations of Atlantic dog
whelk ({\it Nucella lapillus}) in response to predation \citep{vermeij1982phenotypic}. For example, the shell lip thickness
...
\caption{The evolution of {\it Triceratops} from {\it Protoceratops},
  ...
  for a fun updated view of the {\it Coronosauria} phylogeny. \IANC{The dinosaur book : the ruling reptiles and their
...
However, when we observe phenotypic evolution over longer time is much
slower. For example, {\it Triceratops} measured in an impressive 25.9–29.5 ft in length and evolved from a close
...
years. These rates of change in Dinosaurs have nothing on our dog whelks, or any of the
evolution we see on short time scale.    %https://www.geol.umd.edu/~tholtz/G104/lectures/104margino.html

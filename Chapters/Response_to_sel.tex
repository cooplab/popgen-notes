...
We will assume that there is a trait, e.g. tail length, under direct
...
genetically correlated with the male trait, i.e. if $V_{A, \venus
  \mars}$. There's a number of different ways this could happen. The
...
A potentially more general way in which trait-preference genetic correlations may arise
is by assortative mating. 

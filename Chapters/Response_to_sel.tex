...
stickleback evolution from a fossil lake-bed in Nevada. The layers of sediment are layered each year allowing a very detailed
time series to be obtained.
.
Fossil measurements in 250 year bins. Over 5000 fossils measured.

\citet{hunt2008evolution} fitted a model of a population adapting to a
local optimum to these data. 


\begin{marginfigure}
\begin{center}
\includegraphics[width= \textwidth]{illustration_images/Quant_gen/Fossil_stickleback/journal.pbio.1001466.g003.png}
\end{center}
...
\end{center}
\caption{ } \label{fig: Stickleback_fossil_traj}  
\end{marginfigure}

...
\end{equation}
assuming our loci are in linkage disequilibrium. Th
...
\end{equation}
where $V_{A,1}$ and $V_{A,2}$ is the additive genetic variance for trait 1 and 2 respectively. this is a statement to what extent the  additive genetic variance in two traits is shared.   

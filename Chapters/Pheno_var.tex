...
\caption{The Manhattan plot zoomed in on the top-hit (red SNPs from Figure
  ...
  Figure 2 of \ec{end of sentece?}} \label{fig:Apsen_zoom_Manhattan}
\end{figure}
...
our regression of genotype on phenotype ($\alpha_{\ell}$) does not depend on the population

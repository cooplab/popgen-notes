...
\end{center}
\caption{European aspen {\it P. tremula}. \BHLNC{Der baum. H. Schacht. 1860. BHL}{https://archive.org/stream/derbaum00scha/\#page/n284/mode/1up}{The Library of Congress} } \label{fig:Apsen_geno_pheno}
...
noise (in practice we can rarely see such peaks. \gitcode{https://github.com/cooplab/popgen-notes/blob/master/Rcode/Quant_gen/QT1.R}} \label{fig:QT1}
\end{figure}
...
\caption{The additive effect sizes of loci associated with female Age
  ...
  population. Data from \citet{pickrell2016detection}. } \label{fig:AAM_height}   %\cite{potti:11} 
\end{marginfigure}
...
the population in each genotypic class. The regression between phenotype and additive genotype is
  shown as a red line. Data from \citet{barson2015sex}.} \label{fig:salmon_add_dom} %The black vertical arrows show the difference

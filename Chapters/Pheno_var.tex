...
line shows the best fitting linear regression line. \gitcode{https://github.com/cooplab/popgen-notes/blob/master/Rcode/Quant_gen/QT2.R} }
\end{figure}
...
\end{center}
\caption{{\it Ficedula hypoleuca}, Pied fly-catcher.  {Coloured
...
\end{center}
\caption{Atlantic Salmon ({\it Salmo salar}). {Histoire naturelle des
    poissons. 1796. Bloch,

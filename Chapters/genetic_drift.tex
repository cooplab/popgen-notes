...
\marginnote{
\begin{question}
The Californian San Nicolas Channel Island fox is endangered with very
low levels of diversity ($\pi =0.000014 \text{bp}^{-1}$) compared to
its close relative the California mainland gray fox ($0.0012\text{bp}^{-1}$) and 
respectively \cite{robinson:16}. \\
...
\begin{equation}
\E(T_{tot}) = \sum_{i=n-1}^1 \frac{4N}{i} \approx 4N \label{eqn:E_T_tot}
\end{equation}

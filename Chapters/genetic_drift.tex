...
\caption{The black-footed ferret ({\it M. nigripes}). Wild animals of North America, The National geographical
  society, 1918. BHL} \label{fig:LossHet_varying_pop}  
\end{marginfigure} 
\begin{figure}[h]
\begin{center}
\includegraphics[width= 0.75 \textwidth]{Journal_figs/genetic_drift/black_footed_ferrets/black_footed_ferrets_He.pdf}
\end{center}
\caption{Loss of heterozygosity in the Black-footed Ferrets.} \label{fig:LossHet_ferrets}  
\end{figure} 
The population size of the black-footed ferret ({\it Mustela
  nigripes}) declined dramatically through the twentifth century due
...
\paragraph{Estimating levels of constraint.}



\paragraph{Adaptive substitutions}
...
substitutions. dN/dS}
A common test molecular evolution is to compare the ratio of the rates (or number) of non-synonymous to synonymous
substitutions. 

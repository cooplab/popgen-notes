...
Note that some of these concepts may go beyond what you have covered in previous
courses . %I'll refer to this appendix when these concepts first come
%up in the main body of the notes. \graham{T} 
...
time. (This particular obsesssion is shared with much of
science and so the concepts we make use of pop up in many other fields). 
...
\marginnote{ According to Pascal, the expectation is the excitement a gambler feels when placing
...
Our average outcome \sidenote{Recalling that we compute average, the sample mean, of a set of numbers $X_1,\cdots,X_L$ as
\begin{equation}
...
\end{equation}
 ...
 &=  \lim_{n\to\infty} \frac{\lambda^i}{i!} e^{-\lambda}
 \end{align}

...
\begin{figure}
 \begin{center}
   ...
   \textwidth]{math_background/calc_pics/Derivat_all_3.pdf} \end{center}  %{math_background/calc_pics/Derivat.pdf}\end{center}
...
i.e. the concavity/convexity of the function. See Figure \ref{Fig:derivative}.
% \begin{figure}
 %\begin{center}
...
% integral as
% https://twitter.com/fermatslibrary/status/901428083395354625  integral symbol ∫ introduced in 1675 was based on the ſ (long S) character, and was chosen because Leibniz thought of it as an ∞ sum
...
\ref{Fig:Integral_eg}. 
 ...
 \caption{Our function from the top panel of Figure
   ...
   and so is the red area minus the blue area. \gitcode{https://github.com/cooplab/popgen-notes/blob/master/math_background/Calc_background.R}}\label{Fig:Integral_eg}
\end{marginfigure}
...
\begin{margintable}  %https://www.latex4technics.com/?note=msfvja

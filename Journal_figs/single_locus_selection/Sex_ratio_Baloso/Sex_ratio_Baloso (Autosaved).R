...
sex.ratio<-read.csv("~/Dropbox/Courses/Popgen_teaching_Notes/Journal_figs/single_locus_selection/Sex_ratio_Baloso/Sex_ratio_Baloso.csv")
...
dev.copy2pdf(file="~/Dropbox/Courses/Popgen_teaching_Notes/Journal_figs/single_locus_selection/Sex_ratio_Baloso/Sex_ratio_Baloso.pdf")

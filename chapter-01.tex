...
\begin{question}
The frequency of the $A_1$ allele is $p$, and  the frequency of the $A_2$
allele is $q$. Assume that our population is randomly mating and that the
...
from this cross. What is the probability that the child from this sib-mating is
homozygous? 
\end{question}
...
\begin{figure}
% TODO: MISSING FIGURE
\includegraphics[]{figures/Becquet_et_al_STRUCTURE_journal_pgen_0030066_g002.png}
\caption{
PCA analysis of by Becquet {\it et al} (PLOS Genetics 2007) using the same data as in
Figure \ref{fig:chimp_structure}. Here they plot the location of each
individual on the first two principal components in the left panel, } \label{fig:chimp_PCA} % http://journals.plos.org/plosgenetics/article?id=10.1371%2Fjournal.pgen.0030066
%=======
%Individuals 76–78 are reported hybrids. Only two individuals with a $>5\%$ proportion of ancestry in more than one inferred cluster are wild born: number 54 and number 17. Red, central; blue, eastern; green, western; yellow, bonobo.''}
\end{figure}
